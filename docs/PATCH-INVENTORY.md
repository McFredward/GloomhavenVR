...
| `MaterialLoader_LoadMaterials_RegisterPatch`<br/><sub>src/GloomhavenVR/Core/MaterialLoaderHeal.cs:1085</sub> | `MaterialLoader.LoadMaterials()` | postfix | `CompatModule`:137 |
