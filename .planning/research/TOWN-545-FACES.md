...
- Clip the original inner hood to a continuous curved aperture with interpolated original costume UVs. Preserve the intact rear hood; line its actual cut edge. The priestess's continuous fitted linen coif covers scalp and under-chin/neck surfaces instead of leaving hair and a mismatched exposed chest patch.
