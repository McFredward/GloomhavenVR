...
- data: `.planning/voice/shipped.csv` (258 rows) · plot: `.planning/debug/renders/debug/renders/voice/shipped.png`
...
`.planning/debug/renders/debug/renders/voice/voice-icon-sheet.png` (+ per-step PNG/PPM). The frames are rasterised **by the
