...
def mutations():
    return [
        ...
        ("attentive-counter-bracing", "TownServiceActivityMotion.cs", "new Vector3(.27f, .92f, .50f)", "new Vector3(.21f, .959f, .337f)", "attentive priestess hands stay beside her robe and outside the donation bowl"),
        ...
        ("prayer-blocks-bowl", "TownServiceActivityMotion.cs", "new Vector3(.085f, 1.205f, .18f)", "new Vector3(.012f, 1.19f, .20f)", "unavailable temple pose transitions continuously without a wrist snap"),
        ...
        ("merchant-stiff-greeting", "TownServiceActivityMotion.cs", "new Vector3(.30f, .98f, .48f)", "new Vector3(.20f, 1.09f, .20f)", "attentive merchant free hand rests on his hip behind the counter"),
