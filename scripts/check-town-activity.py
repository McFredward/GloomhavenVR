...
def mutations():
    return [
        ...
        ("attentive-counter-bracing", "TownServiceActivityMotion.cs", "new Vector3(.30f, .87f, .015f)", "new Vector3(.21f, .959f, .337f)", "attentive priestess rests both hands on her own hips behind the table edge"),
        ...
        ("prayer-blocks-bowl", "TownServiceActivityMotion.cs", "new Vector3(.085f, 1.205f, .18f)", "new Vector3(.012f, 1.19f, .20f)", "unavailable donation moves both hands over the shared bowl"),
        ("merchant-stiff-greeting", "TownServiceActivityMotion.cs", "new Vector3(.32f, .97f, .04f)", "new Vector3(.20f, 1.09f, .20f)", "visitor attention settles merchant with hands at his hips without an unsolicited offering"),
