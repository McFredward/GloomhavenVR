...
def mutations():
    return [
        ...
        ("attentive-counter-bracing", "TownServiceActivityMotion.cs", "new Vector3(.31f, 1.08f, .20f)", "new Vector3(.21f, .959f, .337f)", "attentive priestess hands stay beside her robe and outside the donation bowl"),
        ...
        ("merchant-stiff-greeting", "TownServiceActivityMotion.cs", "new Vector3(.32f, 1.10f, .18f)", "new Vector3(.20f, 1.09f, .20f)", "attentive merchant free hand rests on his hip behind the counter"),
