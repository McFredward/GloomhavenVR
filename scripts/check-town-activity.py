...
def mutations():
    return [
        ...
        ("attentive-counter-bracing", "TownServiceActivityMotion.cs", "new Vector3(.24f, .74f, .13f)", "new Vector3(.21f, .959f, .337f)", "attentive priestess hands hang fully below the table beside her hips"),
        ...
        ("prayer-blocks-bowl", "TownServiceActivityMotion.cs", "new Vector3(.24f, .74f, .13f)", "new Vector3(.012f, 1.19f, .20f)", "attentive priestess"),
