...
def mutations():
    return [
        ...
        ("attentive-counter-bracing", "TownServiceActivityMotion.cs", "new Vector3(.26f, 1.02f, .30f)", "new Vector3(.21f, .959f, .337f)", "attentive priestess hands stay beside her robe and outside the donation bowl"),
        ...
        ("prayer-blocks-bowl", "TownServiceActivityMotion.cs", "new Vector3(.26f, 1.02f, .30f)", "new Vector3(.012f, 1.19f, .20f)", "attentive priestess"),
        ("merchant-stiff-greeting", "TownServiceActivityMotion.cs", "new Vector3(.29f, 1.02f, .23f)", "new Vector3(.20f, 1.09f, .20f)", "visitor attention settles merchant with hands at his hips without an unsolicited offering"),
