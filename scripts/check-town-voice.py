...
variants=[('production',None,None,None,''),
 ...
 ('ignore-volume','TownServiceVoice.cs','_volume * (IsPrayerCue(cue) ? .12f : .42f)','1f','master and story sliders scale greeting'),
...
variants += [
 ...
 ('repeat-variant','TownServiceVoiceSchedule.cs',
  ...
  'cue = e.LastVariantCue;',
  'second shared experiment varies the spoken phrase without an immediate repeat'),
