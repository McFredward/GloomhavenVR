...
def mutations():
    ...
    return [
        ...
        ("physical-zone-drop", "Token.cs", "WithinDropZone(_mat.InverseTransformPoint(_held.transform.position) - _zoneCenter)", "InDropZone(Vector3.zero)", "physical drop eligibility identity pose zone and cancellation fence 2"),
