...
namespace GloomhavenVR.Net {internal struct TownActivityVisual {internal Vector3 Left {get;set;} internal Vector3 Right {get;set;} internal float Cast {get;set;} internal float CastSway {get;set;} internal float EffectClock {get;set;}} }
