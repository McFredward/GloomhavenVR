...
bash "$ROOT/scripts/story-completion-tests.sh"
bash "$ROOT/scripts/map-story-lifecycle-tests.sh"
bash "$ROOT/scripts/message-continuation-tests.sh"
bash "$ROOT/scripts/announcement-tests.sh"
bash "$ROOT/scripts/dialog-surface-tests.sh"
bash "$ROOT/scripts/vr-options-tests.sh"
bash "$ROOT/scripts/scenario-win-cheat-tests.sh"
...
python3 "$ROOT/tests/GloomhavenVR.AoeControlTests/run.py"
python3 "$ROOT/tests/GloomhavenVR.MapTooltipTransportTests/run.py"
python3 "$ROOT/tests/GloomhavenVR.MapTooltipTests/run.py"
python3 "$ROOT/tests/GloomhavenVR.CityEventButtonTests/run.py"
