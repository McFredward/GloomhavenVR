...
internal static partial class Defaults
{
    ...
    internal const bool EnvSoundAmbienceBed = true;            // => [EnvSound] AmbienceBed  (ON: it IS the 2026-08-22 request — "ich will für beide eine dezente Hintergrundgeräuschkullise" — and off-by-default would ship the silence he reported. It rides [EnvSound] Enabled, so a player who never chose Cellar or Night forest still hears nothing, and it is the quietest continuous emitter in either room: 1.1 dB under the window draught and ~46 dB under a game cue at the shipped dial)
