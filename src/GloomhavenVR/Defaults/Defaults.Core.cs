...
internal static partial class Defaults
{
    ...
    internal const bool OpaquePreviewTiles = true;                        // => [MixedReality] OpaquePreviewTiles  (INERT since build 532: scenery backings retired; persisted key/default retained)
    internal const float UnseenSkirtScale = 1.2f;                         // => [MixedReality] UnseenSkirtScale  (INERT since build 532: scenery backings retired; persisted key/default retained)
    internal const bool UnseenRegionMembership = true;                    // => [MixedReality] UnseenRegionMembership  (INERT since build 532: scenery backings retired; persisted key/default retained)
    internal const bool UnseenBackingDebugColors = false;                 // => [MixedReality] UnseenBackingDebugColors  (INERT since build 532: scenery backings retired; persisted key/default retained)
    internal const float UnseenRimInset = 0.03f;                          // => [MixedReality] UnseenRimInset  (INERT since build 532: scenery backings retired; persisted key/default retained)
    internal const float UnseenRimTopClearance = 0.025f;                   // => [MixedReality] UnseenRimTopClearance  (INERT since build 532: scenery backings retired; persisted key/default retained)
    internal const float UnseenWaferDrop = 0.02f;                         // => [MixedReality] UnseenWaferDrop  (INERT since build 532: scenery backings retired; persisted key/default retained)
