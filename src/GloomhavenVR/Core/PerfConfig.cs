...
internal static class PerfConfig
{
    ...
    internal static void Bind()
    {
        ...
        SceneProfile = _file.Bind("Perf", "SceneProfile", true,
            "Append two more lines to each summary: [Perf] SCENE — the renderer population broken "
            ...
            + "would be a stutter of its own at frame rate.");
