    ...
    private static Dictionary<string, string> BuildGerman() =>
        new(784, StringComparer.Ordinal)
        {
            ...
            ["Water/OwnSurface"] =
                ...
                + "aus. UND DIE FLÄCHE HAT WIRKLICH RELIEF: der Film bekommt ein feiner "
                + "unterteiltes Netz, und eine langsame Dünung bewegt seine Punkte tatsächlich — "
                + "denn keine Schattierung der Welt macht eine ebene Platte dreidimensional, und "
                + "das Urteil über den Versuch lautete 'nur weiße Streifen auf einer flachen "
                + "Oberfläche'. Feineinstellung über [Water] SwellHeight (wie hoch), [Water] "
            ...
            ["Water/RippleSpeed"] =
                "Wie schnell sich das Wasser bewegt, als Vielfaches dessen, was das Spiel "
                + "gestaltet hat. Der Regler betrifft BEIDES: das Tempo der langen Dünung und das "
                + "Driften der beiden feinen Wellenlagen darüber. DIE VOREINSTELLUNG IST EIN "
                + "HALB, nicht eins, und das ist eine Neueichung und kein Geschmack: bis "
                + "ModBuild 163 wurde die gestaltete Rate an den Shader als 'Texturwiederholungen "
                + "pro Sekunde' übergeben, auf dem Bildschirm kam sie deshalb als Rate GETEILT "
                + "durch die Kachelung heraus — 4,3 bzw. 5,0 Meter pro Sekunde über eine Kachel "
                + "von einem Meter, und genau das waren die 'extrem schnellen, hektischen weißen "
                + "Streifen, die vorbeisausen'. Die Rate bedeutet jetzt Meter pro Sekunde, "
                + "unabhängig von der Kachelung, und die Hälfte der gestalteten 0,6 ist das "
                + "Driften ruhigen Wassers. Das Log schreibt die aufgelöste Rate in Metern pro "
                + "Sekunde mit, 'zu schnell' ist also eine Zahl und keine Diskussion. 0 friert "
                + "die Fläche ein, ohne sonst etwas am Aussehen zu ändern.",
            ["Water/Shimmer"] =
                ...
                + "Deckkraft nicht mehr an. 0 nimmt die Glanzlichter heraus und lässt die "
                + "Wellenschattierung stehen. Höher, wenn der Tümpel tot wirkt; niedriger, wenn "
                + "das Funkeln unruhig ist oder kribbelt.",
            ["Water/WaveScale"] =
                ...
                + "Welle mit falsch skalierter Struktur zerfällt. 1,0 legt etwa drei Wellenkämme "
                + "über einen Tümpel aus Ein-Meter-Feldern (1,6 m Wellenlänge). Höher für eine "
                + "längere, trägere Dünung; niedriger für kabbeligeres Wasser. Die "
                + "Geschwindigkeit ändert sich dadurch nicht: das Tempo wächst mit der "
                + "Wellenlänge mit, eine längere Welle braucht also entsprechend länger zum "
                + "Durchlaufen und das Wasser behält seinen Charakter. Das Log schreibt die "
                + "aufgelösten Wellenlängen in Metern mit.",
            ["Water/SwellHeight"] =
                "Wie HOCH die Dünung das Wasser anhebt, als Bruchteil der Breite eines einzelnen "
                + "Wasserfeldes — ein Feld von etwa einem Meter bekommt bei der Voreinstellung "
                + "also 2 cm, und ein Diorama in anderem Maßstab bekommt eine Welle, die genauso "
                + "aussieht, statt einer unsichtbaren oder einer riesigen. DAS IST ECHTE "
                + "GEOMETRIE, keine Schattierung: der Film bekommt ein feiner unterteiltes Netz "
                + "und seine Punkte bewegen sich wirklich. Genau das lässt die Fläche im flachen "
                + "Blickwinkel dreidimensional wirken, statt wie Streifen, die auf eine ebene "
                + "Platte gemalt sind. Die Welle ist eine Funktion von Ort und Zeit allein, sie "
                + "ist also in beiden Augen identisch. 0 gibt dem Film sein ursprüngliches Netz "
                + "zurück und macht ihn wieder flach — das ist zugleich der direkte Vergleich, ob "
                + "das Relief seine Dreiecke wert ist. Die Obergrenze ergibt sich aus den 9 cm, "
                + "die zwischen dem Wasser und dem Beckenbett darunter gemessen wurden: ein "
                + "Wellental darf niemals durch den eigenen Beckenboden stoßen.",
            ["Water/DebugPaint"] =
