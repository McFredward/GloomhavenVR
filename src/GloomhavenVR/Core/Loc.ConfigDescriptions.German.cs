    ...
    private static Dictionary<string, string> BuildGerman() =>
        new(784, StringComparer.Ordinal)
        {
            ...
            ["Sky/Style"] =
                ...
                + "SPIELBRETT: der Raum ist auf das Diorama zentriert, sein Boden liegt "
                + "genau auf der Unterseite des Bretts, und er ist rund dreimal so breit "
                + "wie das Brett, damit du um den Tisch herumgehen kannst. DAS BRETT "
                ...
                + "der Ort wie ein Modell vor dir, hereingezoomt stehst du darin. Das "
