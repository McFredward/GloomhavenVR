    ...
    private static Dictionary<string, string> BuildGerman() =>
        new(784, StringComparer.Ordinal)
        {
            ...
            ["Sky/Style"] =
                ...
                + "ORT IN DER WELT um dich auf — etwa 9 m groß, am Boden ausgerichtet an deiner "
                + "aktuellen Position und Blickrichtung, du stehst im Raum und der Szenario-Tisch "
                + "bleibt unverändert vor dir. Stick-Flug, Drehen, das Welt-Greifen und "
