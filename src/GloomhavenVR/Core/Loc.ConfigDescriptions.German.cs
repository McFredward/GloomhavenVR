...
internal static partial class Loc
{
    private static Dictionary<string, string> BuildGerman() =>
        new(784, StringComparer.Ordinal)
        {
            ...
            // ---- [Sky] ----
            ["Sky/Style"] =
                "Welche Umgebung den Tisch umgibt (Nutzer-Entscheid 2026-08-12: echte 3D-Umgebungen "
                + "statt der früheren Panorama-Skyboxen — wie kleine VRChat-Worlds, nicht interaktiv, "
                + "rein als Umgebung). Default = der eigene animierte Himmel des Spiels, exakt wie "
