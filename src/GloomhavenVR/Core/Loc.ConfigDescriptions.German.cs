    ...
    private static Dictionary<string, string> BuildGerman() =>
        new(784, StringComparer.Ordinal)
        {
            ...
            ["EnvSound/Enabled"] =
                ...
                + "der Tropfen klingt, wenn er auftrifft, das Bücherregal KRACHT in dem Moment, in dem "
                + "es den Boden berührt, das Feuer antwortet auf eine Feuer-Infusion, der Wind auf "
