...
internal static partial class Loc
{
    ...
    private static Dictionary<string, Dictionary<string, string>> BuildConfigNames() =>
        new(512, StringComparer.Ordinal)
        {
            ...
            ["FigureGrab/PropHeldSameInBothHands"] = Pair("Map item: same in both hands", "Map-Item: in beiden Händen gleich"),
            ...
            ["Cards/SpawnBoardWidthDegrees"] = Pair("Board at spawn: size (\u00b0 wide)", "Brett beim Spawn: Größe (\u00b0 breit)"),
            ...
            ["Cards/BoardApparentWidth_*"] = Pair("Board: your size (m wide)", "Brett: deine Größe (m breit)"),
            ...
            ["WorldUI/ImmersiveTownServices"] = Pair("Immersive town visits", "Immersive Stadtbesuche"),
