...
internal static partial class Loc
{
    ...
    private static Dictionary<string, Dictionary<string, string>> Build() => new(64)
    {
        ...
        // ---- THE DIAGNOSTIC SWITCHES: the rows on this page that are real settings ------------
        // The whole page otherwise consists of latches that persist nothing, and its first note says
        // so. These rows break that, so they carry their own heading and their own two notes rather
