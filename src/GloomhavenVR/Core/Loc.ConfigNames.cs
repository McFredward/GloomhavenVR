...
internal static partial class Loc
{
    ...
    private static Dictionary<string, Dictionary<string, string>> BuildConfigNames() =>
        new(512, StringComparer.Ordinal)
        {
            ...
            ["Core/InitDelayFrames"] = Pair("Start delay (frames)", "Startverzögerung (Frames)"),
            ["Dev/Enabled"] = Pair("Developer mode", "Entwicklermodus"),
            ["Dev/Overlay"] = Pair("Dev overlay at start", "Dev-Overlay beim Start"),
            ["Dev/SimulateHands"] = Pair("Simulate hands (desktop)", "Hände simulieren (Desktop)"),
            ...
            ["Compat/DisableComponents"] = Pair("Disabled components", "Abgeschaltete Komponenten"),
            ...
            ["Comfort/TableScaleDefault25Applied"] = Pair("Internal migration marker", "Interne Migrationsmarke"),
            ...
            ["Hands/ScrollWithStickOnly"] = Pair("Scroll with stick only", "Nur mit dem Stick scrollen"),
            ...
            ["Hands/GlovePinkyCounterAbduction"] = Pair("Glove: pinky angle (°)", "Handschuh: Kleinfinger (°)"),
            ...
            ["Hands/CurlProximal"] = Pair("Finger curl: knuckle (°)", "Fingerkrümmung: Wurzel (°)"),
            ["Hands/CurlMiddle"] = Pair("Finger curl: middle (°)", "Fingerkrümmung: Mitte (°)"),
            ["Hands/CurlTip"] = Pair("Finger curl: tip (°)", "Fingerkrümmung: Spitze (°)"),
            ...
            ["WorldUI/WristHudPitch"] = Pair("Wrist HUD: pitch (°)", "Handgelenk-HUD: Neigung (°)"),
            ["WorldUI/WristHudYaw"] = Pair("Wrist HUD: yaw (°)", "Handgelenk-HUD: Gieren (°)"),
            ["WorldUI/WristHudRoll"] = Pair("Wrist HUD: roll (°)", "Handgelenk-HUD: Rollen (°)"),
            ["WorldUI/WristHudOffsetX"] = Pair("Wrist HUD: X (m)", "Handgelenk-HUD: X (m)"),
            ["WorldUI/WristHudOffsetY"] = Pair("Wrist HUD: Y (m)", "Handgelenk-HUD: Y (m)"),
            ["WorldUI/WristHudOffsetZ"] = Pair("Wrist HUD: Z (m)", "Handgelenk-HUD: Z (m)"),
            ["WristHud/*Pitch"] = Pair("Wrist HUD: pitch (°)", "Handgelenk-HUD: Neigung (°)"),
            ["WristHud/*Yaw"] = Pair("Wrist HUD: yaw (°)", "Handgelenk-HUD: Gieren (°)"),
            ["WristHud/*Roll"] = Pair("Wrist HUD: roll (°)", "Handgelenk-HUD: Rollen (°)"),
            ["WristHud/*OffsetX"] = Pair("Wrist HUD: X (m)", "Handgelenk-HUD: X (m)"),
            ["WristHud/*OffsetY"] = Pair("Wrist HUD: Y (m)", "Handgelenk-HUD: Y (m)"),
            ["WristHud/*OffsetZ"] = Pair("Wrist HUD: Z (m)", "Handgelenk-HUD: Z (m)"),
            ...
            ["Board/AoeFlickThreshold"] = Pair("AoE turn: stick threshold", "AoE-Drehen: Stick-Schwelle"),
            ["Board/AoeRepeatInterval"] = Pair("AoE turn: repeat (s)", "AoE-Drehen: Wiederholung (s)"),
            ...
            ["HexHighlight/KillBorderFlame"] = Pair("Fallback: border flame off", "Fallback: Randflamme aus"),
            ["HexHighlight/KillCrosshair"] = Pair("Fallback: crosshair off", "Fallback: Fadenkreuz aus"),
            ["HexHighlight/KillBorderLine"] = Pair("Fallback: border line off", "Fallback: Randlinie aus"),
            ...
            ["FigureGrab/HeldUprightAtGrab"] = Pair("Figure: upright on grab", "Figur: aufrichten beim Griff"),
            ...
            ["Cards/DevFakeHand"] = Pair("Debug: test cards (count)", "Debug: Testkarten (Anzahl)"),
            ...
            ["Cards/HeldFaceBias"] = Pair("Held card: face tilt (°)", "Karte in Hand: Winkel (°)"),
            ["Cards/HeldForward"] = Pair("Held (fallback): fwd (m)", "Karte (Ersatz): vor (m)"),
            ["Cards/HeldOffPalm"] = Pair("Held (fallback): gap (m)", "Karte (Ersatz): Abstand (m)"),
            ["Cards/HeldPinchOffset"] = Pair("Held card: pinch offset", "Karte: Griffpunkt-Versatz"),
            ...
            ["Cards/BoardScaleDefault04Applied"] = Pair("Internal migration marker", "Interne Migrationsmarke"),
            // Fan behaviour & shape.
            ["Cards/FanCurveByFill"] = Pair("Fan: curve by hand size", "Fächer: Bogen nach Füllung"),
            ["Cards/FanMaxHandForCurve"] = Pair("Fan: full curve at N", "Fächer: voller Bogen ab N"),
            ...
            ["Cards/FanFollowDeadzone"] = Pair("Fan: follow deadzone (m)", "Fächer: Folge-Totzone (m)"),
            ["Cards/RevealIgnoreWhenGrabbing"] = Pair("Fan: not while grabbing", "Fächer: nicht beim Greifen"),
            ["Cards/FanOpenDuration"] = Pair("Fan: open time (s)", "Fächer: Öffnungsdauer (s)"),
            ...
            ["Cards/FanPerCardStepDegrees"] = Pair("Fan: step per card (°)", "Fächer: Winkel je Karte (°)"),
            ["Cards/FanArcSweepDegrees"] = Pair("Fan: total arc (°)", "Fächer: Gesamtbogen (°)"),
            ["Cards/FanEffectiveRadius"] = Pair("Fan: effective radius (m)", "Fächer: wirksamer Radius"),
            ["Cards/FanHoverSplitScale"] = Pair("Fan: hover gap scale", "Fächer: Hover-Lücke"),
            ["Cards/BrowseFanOffset"] = Pair("Browse fan: offset (m)", "Stapel-Fächer: Versatz (m)"),
            ...
            ["Cards/FanCurveMinCards"] = Pair("Fan: flat up to N cards", "Fächer: flach bis N Karten"),
            ["Cards/FanGazeBias"] = Pair("Fan: gaze-follow yaw", "Fächer: Blick-Drehung"),
            ["Cards/FanFaceViewer"] = Pair("Fan: cards face you", "Fächer: Karten zum Spieler"),
            ...
            ["Cards/ConfirmUndoOffset_*"] = Pair("Confirm/Undo: position", "Bestätigen/Zurück: Position"),
            ["Cards/ConfirmUndoSize_*"] = Pair("Confirm/Undo: size (m)", "Bestätigen/Zurück: Größe"),
            ["Cards/GenericButtonSpacing_*"] = Pair("Confirm/Undo: gap (m)", "Bestätigen/Zurück: Abstand"),
            ...
            ["Cards/DecisionOffset_*"] = Pair("Decision dock: position", "Entscheidungsdock: Position"),
            ["Cards/DecisionScale_*"] = Pair("Decision dock: size", "Entscheidungsdock: Größe"),

            // ---- [MixedReality] / [Stereo] / [RenderQuality] — picture ----------------------
            ["MixedReality/Enabled"] = Pair("Mixed Reality", "Mixed Reality aktivieren"),
            ...
            ["RenderQuality/ViewportScaleFallback"] = Pair("Viewport-scale fallback", "Viewport-Ersatzskalierung"),
            ...
            ["WallFade/OnFraction"] = Pair("Fade at coverage", "Ausblenden ab Verdeckung"),
            ...
            ["WallFade/ExitDwellStationarySeconds"] = Pair("Unfade dwell, still (s)", "Wartezeit ohne Bewegung (s)"),
            ...
            ["Optimize/FanRelayoutMinInterval"] = Pair("Fan relayout min (s)", "Fächer-Relayout min. (s)"),
            ...
            ["WorldUI/BarFixedSize"] = Pair("Health bars: fixed size", "Lebensbalken: feste Größe"),
            ["WorldUI/BarsOccluded"] = Pair("Health bars behind walls", "Lebensbalken hinter Wänden"),
            ["WorldUI/FlatScreen"] = Pair("Floating 2D screen", "Schwebender 2D-Bildschirm"),
            ...
            ["WorldUI/CatchAllModals"] = Pair("Catch unknown windows", "Unbekannte Fenster fangen"),
            ["WorldUI/MenuPopupFloat"] = Pair("Float error popups", "Fehlermeldungen schwebend"),
            ...
            ["WorldUI/InitiativeDepthMaxSpreadPx"] = Pair("Initiative: 3D depth (px)", "Initiative: 3D-Tiefe (px)"),
            ["WorldUI/DecisionRowGapPx"] = Pair("Decision row gap (px)", "Entscheidung: Abstand (px)"),
            ["WorldUI/HoverInfoScale"] = Pair("Hover info size", "Info-Karten: Größe"),
            ["WorldUI/EnemyRevealBoardClearance"] = Pair("Enemy cards: clearance", "Gegnerkarten: Abstand (m)"),
            ["WorldUI/FlatScreenAutoShow"] = Pair("2D screen automatic", "2D-Bildschirm automatisch"),
            ...
            ["WorldUI/ScreenWidth"] = Pair("2D screen: width (m)", "2D-Bildschirm: Breite (m)"),
            ["WorldUI/ScreenDistance"] = Pair("2D screen: distance (m)", "2D-Bildschirm: Abstand (m)"),
            ["WorldUI/ClickLatch"] = Pair("Freeze click position", "Klick-Position einfrieren"),
            ...
            ["WorldUI/DecisionPokeDeliberate"] = Pair("Decisions: firm press", "Entscheidung: fest drücken"),
            ...
            ["WorldUI/PanelsFollowView"] = Pair("Panels follow view (old)", "Tafeln folgen Blick (alt)"),
            ...
            ["WorldUI/ManualScreenChordSeconds"] = Pair("Rescue chord: hold (s)", "Notgriff: Haltedauer (s)"),
            ["WorldUI/DemoteOverlaySolidClears"] = Pair("Demote overlay clears", "Overlay-Clears abschwächen"),
            ...
            ["WorldUI/DevForceConvert"] = Pair("Dev: force conversion", "Dev: Konvertierung erzwingen"),
            ...
            ["WorldUI/MapAlbedoRender"] = Pair("Map fix (unlit render)", "Karten-Fix (unbeleuchtet)"),
            ...
            ["RoundButtons/OffsetX"] = Pair("Round btns: sideways (m)", "Rundenknöpfe: seitlich (m)"),
            ["RoundButtons/OffsetY"] = Pair("Round btns: up-board (m)", "Rundenknöpfe: hoch (m)"),
            ["RoundButtons/OffsetZ"] = Pair("Round btns: proud (m)", "Rundenknöpfe: heraus (m)"),
            ["RoundButtons/Shape"] = Pair("Round btns: shape", "Rundenknöpfe: Form"),
            ["RoundButtons/CapSize"] = Pair("Round btns: cap size (m)", "Rundenknöpfe: Größe (m)"),
            ["RoundButtons/Width"] = Pair("Round btns: width (m)", "Rundenknöpfe: Breite (m)"),
            ["RoundButtons/Height"] = Pair("Round btns: height (m)", "Rundenknöpfe: Höhe (m)"),
            ["RoundButtons/Depth"] = Pair("Round btns: depth (m)", "Rundenknöpfe: Tiefe (m)"),
            ["RoundButtons/Travel"] = Pair("Round btns: travel (m)", "Rundenknöpfe: Hub (m)"),
            ["BoardButtons/Width"] = Pair("Confirm/Undo: width (m)", "Bestätigen/Zurück: Breite"),
            ["BoardButtons/Height"] = Pair("Confirm/Undo: height (m)", "Bestätigen/Zurück: Höhe"),
            ["BoardButtons/Depth"] = Pair("Confirm/Undo: depth (m)", "Bestätigen/Zurück: Tiefe"),
            ["BoardButtons/Travel"] = Pair("Confirm/Undo: travel (m)", "Bestätigen/Zurück: Hub"),
            ["BoardDashboard/PinWidth"] = Pair("Pin plate: width (m)", "Fixiert-Taste: Breite (m)"),
            ["BoardDashboard/Height"] = Pair("Pin plate: height (m)", "Fixiert-Taste: Höhe (m)"),
            ["BoardDashboard/Depth"] = Pair("Gear/pin: depth (m)", "Zahnrad/Fixiert: Tiefe (m)"),
