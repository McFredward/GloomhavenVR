...
internal static partial class Loc
{
    ...
    private static Dictionary<string, Dictionary<string, string>> Build() => new(64)
    {
        ...
        ["vr_o_laseraxis"] = Pair("Laser follows the finger", "Laser folgt dem Finger"),
        ...
        ["h_vr_o_laseraxis"] = Pair("Aim along the index finger of the hand you see, so the beam follows every hand setting.", "Zielt entlang des Zeigefingers der sichtbaren Hand — der Strahl folgt damit jeder Handeinstellung."),
