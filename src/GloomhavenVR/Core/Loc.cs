...
internal static partial class Loc
{
    ...
    private static Dictionary<string, Dictionary<string, string>> Build() => new(64)
    {
        ...
        ["vr_o_recenterhold"] = Pair("Recenter hold time", "Haltezeit zum Zentrieren"),
        ...
        ["vr_o_raycone"] = Pair("Laser cone width", "Laser-Kegelbreite"),
        ...
        ["vr_o_circle"] = Pair("Seat players in a circle", "Spieler im Kreis platzieren"),
        ["vr_o_hidesky"] = Pair("Hide sky geometry", "Himmelsgeometrie ausblenden"),
        ["vr_o_gfxjobs"] = Pair("Threaded render submission", "Parallele Bildabgabe"),
        ["vr_o_autorestart"] = Pair("Restart once automatically", "Einmal automatisch neu starten"),
        ["vr_o_actorbars"] = Pair("Health bars", "Lebensbalken"),
        ["vr_o_buttoncluster"] = Pair("Wrist buttons", "Tasten am Handgelenk"),
        ["vr_o_dialogs"] = Pair("Dialogs in VR", "Dialoge in VR"),
        ["vr_o_decisiondock"] = Pair("Decision dock", "Entscheidungsleiste"),
        ["vr_o_enemyreveal"] = Pair("Enemy card reveal", "Gegnerkarten aufdecken"),
        ["vr_o_trayscale"] = Pair("Control board size", "Größe des Kontrollbretts"),
        ["vr_o_trayfollow"] = Pair("Control board follows you", "Kontrollbrett folgt dir"),
        ["vr_o_inspectscale"] = Pair("Close-up size", "Größe der Nahansicht"),
        ["vr_o_revealmode"] = Pair("How the fan opens", "Wie der Fächer aufgeht"),
        ...
        ["vr_o_netenabled"] = Pair("Multiplayer VR sync", "VR-Abgleich im Mehrspieler"),
