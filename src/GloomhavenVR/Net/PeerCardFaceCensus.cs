...
internal static class PeerCardFaceCensus
{
    ...
    internal static void PrintIfDue()
    {
        ...
        VRLog.Note("Net", $"PEER CARD FACE CENSUS (every {CensusSeconds:F0} s, the LIVE picture at "
            ...
            + "the same phase rule as held cards. SHORT REST RUNS INSIDE THIS WINDOW AND IS "
            + "COVERED WITH IT; its burn flight remains covered after acceptance. "
            + "'flight slab' is EVENT-DRIVEN — its ticks are "
