...
internal static class PresenceSerializer
{
    ...
    /// + 28 (track order: 2 + count 1 + owned mask 1 + 4 × its 6-id cap) = 930.
    ///
    /// <para>USE BARS (25) and TRACK ORDER (27) each added their worst case here in their own
    /// commit, per the rule below: 859 → 930 against the 1280 bound, i.e. 350 bytes of margin —
    /// still more than seven times the largest record in the tail.</para>
    ///
