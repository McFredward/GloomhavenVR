...
internal static class NetProtocol
{
    ...
    // Id 23 is TAKEN since the 1:1 damage-prompt round — DECISION DISPLAY STATE, declared beside
    // record 12 further down (the two decision records belong together). 18..21 remain free.
    ...
    // ---- record 23: DECISION DISPLAY STATE --------------------------------------------------
    ...
    /// it.</para>
    /// </summary>
    public const byte ExtIdDecisionState = 23;
