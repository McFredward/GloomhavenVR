...
internal static class NetProtocol
{
    ...
    public const ushort ModBuild = 56;
    ...
    // NOTE: ids 11..13 are reserved for a parallel worker batch; this batch owns 14..16.
    ...
    /// <c>CActor.ID</c> is the same cross-client id space the held-figure records already use.
