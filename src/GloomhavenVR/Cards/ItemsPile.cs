...
internal sealed class ItemsPile
{
        ...
        IFanSweepTarget
    {
        ...
        internal void SetHome(Vector3 pos, Quaternion rot, float scale)
        {
            ...
            _homeRot = rot;
            _homeScale = scale;
            // RECORD the home, but do NOT move a chip whose pose somebody else owns:
            ...
            //   • GLIDING (_releaseGlide) — the chip is flying home / emerging, and Update's lerp is
            //     already aimed at the very fields written above. Teleporting it here CANCELS that
            ...
            //     and neither would the animated return this method's other callers promise. The
            //     glide keeps converging on the NEW home, which is what a relayout mid-flight should
            //     mean anyway.
            if (Holder != null || PendingUse || _releaseGlide > 0f)
                return;
