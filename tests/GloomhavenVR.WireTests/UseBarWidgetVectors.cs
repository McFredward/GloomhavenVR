...
internal static class UseBarWidgetVectors
{
    public static void Run(Harness t)
    {
        ...
        {
            Slot = 2, Flags = 3, ConsumeIcons = new byte[] { 1, 7 },
        ...
        t.Wire(Hex.Bytes("31 52 56 47 03 01 80 00 80 00 01 2F 15 02 03 02 01 07 02 04 03 09 FF 85 FF 81 A0 00 84 82 98 02 81 86"),
        ...
        t.Equal(203, UseBarWidgetCodec.PayloadBytes(maximum), "full slot fits one 255-byte TLV");
        int at = 0;
        UseBarWidgetCodec.Write(maximum, buffer, ref at);
        t.Equal(203, at, "actual written maximum matches budget");
        ...
        t.Equal(11 + 8 * 205, count, "eight whole descriptors retain every native subwidget");
        ...
        t.True(PresenceSerializer.MaxSize >= 3441 + 257, "full extras budget leaves a complete record margin");
