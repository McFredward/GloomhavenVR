...
internal static class MapSyncVectors
{
    internal static void Run(Harness t)
    {
        ...
        t.Equal(4088, PresenceSerializer.MaxSize,
                "MB489 raises the buffer to4088 for records57/60/61/62 (worst3823, margin265). MaxSize was raised 1600 -> 1800 when records 20 and 21 landed: the worst case went "
