...
internal static class MapSyncVectors
{
    internal static void Run(Harness t)
    {
        ...
        t.Equal(3970, PresenceSerializer.MaxSize,
                "MB487 raises the buffer to3970 for records54/55 (worst3709, margin261). MaxSize was raised 1600 -> 1800 when records 20 and 21 landed: the worst case went "
