...
internal static class GoldenVectors
{
    ...
    public static void Run(Harness t)
    {
        ...
        Vector3 asset = NetProtocol.BoardTuneVector(mix.BoardTuningBytes, 0, mix.BoardTuningLength,
        ...
        t.Equal(0.07f, NetProtocol.BoardTuneLength(mix.BoardTuningBytes, 0, mix.BoardTuningLength,
                                                   NetProtocol.TuneCardWidth, 0f),
                "a LENGTH field decodes in tenth-millimetres");
        t.Equal(1.25f, NetProtocol.BoardTuneFactor(mix.BoardTuningBytes, 0, mix.BoardTuningLength,
                                                   NetProtocol.TuneObjectivesScale, 0f),
                "a FACTOR field decodes in thousandths");
        t.Equal(57f, NetProtocol.BoardTuneAngle(mix.BoardTuningBytes, 0, mix.BoardTuningLength,
                                                NetProtocol.TuneAssetPitch, 0f),
                "an ANGLE field decodes in hundredth-degrees");
        t.Equal(8, NetProtocol.BoardTuneCount(mix.BoardTuningBytes, 0, mix.BoardTuningLength,
                                              NetProtocol.TuneFanMaxHandForCurve, 0),
                "a COUNT field is one plain byte");
        t.Equal(2f, NetProtocol.BoardTuneFactor(mix.BoardTuningBytes, 0, mix.BoardTuningLength,
