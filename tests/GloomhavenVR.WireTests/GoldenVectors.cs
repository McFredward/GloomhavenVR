...
internal static class GoldenVectors
{
    ...
    public static void Run(Harness t)
    {
        ...
        t.Wire(Hex.Bytes(@"
            ...
            02               // tail: 2 records
            0C 02 4A 61      // id 12 decision lines: 'Ja'
            17 05            // id 23 (decision state), len 5
            09               // flags: kind 1 (take damage) | variant 1 (deal damage) << 3
            03               // 3 options
            01 02 05         // #0 offered, #1 dimmed, #2 offered+chosen
            "), ext, m, "the decision-state record is [id 23][len][flags][n][n option bytes], "
        ...
        byte[] lyingDs = Hex.Bytes(@"
            31 52 56 47 03 01 80 00
            80 00 02
            17 04 09 FF 01 02          // id 23, len 4: claims 255 options, carries 2
            03 07 01 00 30 2E 31 2E 30 // id 3, mod version: build 1, '0.1.0'
            ");
        ...
        byte[] overCap = Hex.Bytes(@"
            31 52 56 47 03 01 80 00
            80 00 01
            17 0D 09 0C 01 01 01 01 01 01 01 01 01 01 01 01
            ");
        ...
        byte[] cutDs = Hex.Bytes("31 52 56 47 03 01 80 00 80 00 01 17 05 09");
